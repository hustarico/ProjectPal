package com._4.ProjectPal.service;
...
/**
 * Central utility for all JWT operations: creation, parsing, and validation.
 */
@Service
public class JwtService {
    ...
    /**
     * Validates the token: checks that it belongs to the provided user and is not expired.
     */
    ...
    /** Parses the signed JWT and returns the full claims body. */
    ...
    /** Decodes the Base64 secret and returns an HMAC-SHA key suitable for JWT signing. */
